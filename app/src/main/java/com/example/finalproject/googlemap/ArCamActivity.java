...
import com.example.finalproject.retrofit.pojo.mapar.Step;
...
import com.example.finalproject.googlemap.ar.ArFragmentSupport;
...
//        Directions_call();
    ...
    private void Get_intent(){
        if(getIntent()!=null) {
            intent = getIntent();
            srcDestText.setText(intent.getExtras().getString("SRC")+" -> "+intent.getExtras().getString("DEST"));
            srcLatLng=intent.getExtras().getString("SRCLATLNG");
            destLatLng=intent.getExtras().getString("DESTLATLNG");
    ...
    private void Directions_call(){
        ...
        final Call<DirectionsResponse> call = apiService.getDirections(srcLatLng, destLatLng,"transit",
